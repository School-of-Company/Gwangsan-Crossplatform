...
// 링크 자체 패딩(위아래 12)에 더해 최소 44pt 터치 영역을 보장한다.
        ...
        <View className="gap-8 px-6">
          ...
          <View className="mt-4 flex-row justify-center gap-2">
            <TouchableOpacity
              ...
              <Text className="text-body4 text-gray-600 underline">별칭 찾기</Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Text className="text-body4 text-gray-600 underline">비밀번호 변경하기</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
